			...
			<div className="flex flex-col-reverse gap-8 md:flex-row">
				<div className="flex flex-col gap-4">
					...
					<p className="text-justify">
						I'm Kobin, a BSc. CSIT student at TU IOST and the owner of Binary SoftTech, a tech company we founded to provide top-notch software development and IT consulting services. When I'm not working on exciting new projects, I enjoy attending tech conferences and giving back to my community through volunteer work.
					</p>
				</div>
				<Image
					src={Avatar}
